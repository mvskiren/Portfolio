...
import Cognizant from "./Descriptions/Cognizant";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Cognizant");
  return (
    <div
      data-aos="fade-up"
...
const CompaniesBar = (props) => {
  const [barPosition, setBarPosition] = React.useState<Number>(-3); // Green bar position by the default it's -20px
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="Cognizant (Pearson - US)"
            BarPosition={-12}
            BarAvobePosition={1}
            DescriptionJob="Cognizant"
            CompanyNameBackgroundColorGreen={[true, false, false]}
            setDescriptionJob={props.setDescriptionJob}
          />
          <CompanyButton
            ButtonOrderOfcompanyNameBackgroundColorGreen={1}
            CompanyName="TCS (BT Group - UK)"
            BarPosition={32}
            BarAvobePosition={2}
