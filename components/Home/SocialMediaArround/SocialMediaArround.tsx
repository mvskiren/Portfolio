        ...
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <IconClickableWithAnimation
              Icon={GithubIcon}
              href={"https://github.com/mvskiren"}
            />
            {/* Linkedin icon */}
            <IconClickableWithAnimation
              Icon={LinkedinIcon}
              href={"https://www.linkedin.com/in/mvskiran/"}
            />
            <IconClickableWithAnimation
              Icon={MediumIcon}
              href={"https://www.medium.com/@mvskiran/"}
            />
          </div>
