...
import Testimonials from "../components/Testimonials/TestimonialsGrid";
export default function Home() {
  ...
  const meta = {
    title: "Mvs Kiran - Frontend Engineer",
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://mvskiran.dev`} />
        <link rel="canonical" href={`https://mvskiiran.dev`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Mvs Kiran" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@mvskiran" />
      ...
      <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
        ...
        {context.sharedState.finishedLoading ? <BlogGrid /> : <></>}
        {context.sharedState.finishedLoading ? <Testimonials /> : <></>}
        {context.sharedState.finishedLoading ? <GetInTouch /> : <></>}
        {context.sharedState.finishedLoading ? (
          <Footer
            githubUrl={"https://github.com/mvskiren"}
